...
RPMs for armv7hl and aarch64 are built by the GitHub Actions workflow in `.github/workflows/build.yml` on every push to `main`, and attached to GitHub releases when one is published.
