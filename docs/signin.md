...
Signing out (from the settings page) removes the token from Sailfish Secrets, empties the private cache — including every downloaded document — and returns to the sign-in page.
