...
public:
    ...
    // Saves a document into ~/Downloads, where files that came off the network
    // are kept and which is also the only way another app can open it: the cache
    // directory is invisible outside this sandbox.
